    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('homepage', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='boxes', to='ceda.HomePage')),
            ],
            options={
                'ordering': ('_order',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('portfolioitem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='ceda.PortfolioItem')),
            ],
            options={
                'ordering': ('_order',),
                'verbose_name': 'Image',
        ...
        migrations.AddField(
            ...
            name='categories',
            field=models.ManyToManyField(blank=True, related_name='portfolioitems', to='ceda.PortfolioItemCategory', verbose_name='Categories'),
        ),
    ]
